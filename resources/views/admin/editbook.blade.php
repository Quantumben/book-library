                ...
                <div class="card">
                    ...
                    <form action="{{route('add-books')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" value="{{$sBook->name}}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="Name of Author" class="col-sm-2 col-form-label">Name of Author</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="author" value="{{$sBook->author}}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="file" class="form-control" name="file" value="{{public_path($sBook->file)}}">
                            </div>
                        </div>
